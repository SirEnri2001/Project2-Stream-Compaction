...
const int ARRAY_SIZE = 1<<6; // feel free to change the ARRAY_SIZE of array
...
int main(int argc, char* argv[]) {
    ...
    genArray(ARRAY_SIZE - 1, a, 100);  // Leave a 0 at the end to test that edge case
    a[ARRAY_SIZE - 1] = 0;
